...
public class RedisDAOTest extends TestCase {
    ...
    il corrispondente username è nella
  ...
  */
    ...
    public void testCheckUsernameAvailability()  {
        ...
        /*
        metodo eseguito su username già presenti nel database
    ...
    public void testAvailableUrl(){
        ...
        /*
        metodo eseguito su shortsUrl già presenti nel database
        deve restituire sempre false
         */
    ...
    public void testFindLongUrl(){
        ...
        /*
        metodo eseguito su shortURL già presenti nel database
    ...
    public void testGetLastShortURLAutogenerated(){
        ...
        eseguendo il metodo gestLastShortURLAutogenerated è stringa vuota
        perché nessun link salvato ha come parametro autogenerated=true
         */
        assertTrue(result.equals(""));
        ...
        assertTrue(result.equals("")); // con il database vuooto il risultato atteso è proprio stringa vuota;
        ...
        result=rd.getLastShortURLAutogenerated();
        assertTrue(result.equals("short1")); //adesso il risultato atteso è short1
        ...
        result=rd.getLastShortURLAutogenerated();
        assertTrue(result.equals("short8")); //adesso il risultato atteso è short8
        ...
        result=rd.getLastShortURLAutogenerated();
        assertTrue(result.equals("short10")); //adesso il risultato atteso è short10
    }
